      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              AppText(title: 'Select your preferences to get a tailored \n  interview experience.',
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: [
                  AppText(title: 'Choose question Difficulty',
                    color: AppColors.inputText,
                    fontSize: 18,
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: selectedIndex == 0 ? const Color(0xFFDFA7A7).withOpacity(0.87) : Colors.transparent,
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        AppText(title: 'Easy - Entry Level',
                        color: AppColors.inputText,
                        fontWeight: FontWeight.w400,
                        fontSize: 18,),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  height: 56.h,
                  decoration: BoxDecoration(
                    color: selectedIndex == 1 ? const Color(0xFFDFA7A7).withOpacity(0.87) : Colors.transparent,
                    borderRadius: BorderRadius.circular(15.r),
                    border: Border.all(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Image.asset('medium'.assetPNG,width: 36.w,height: 36.h,),
                        SizedBox(
                          width: 8.w,
                        ),
                        AppText(title: 'Medium - Intermediate Level',
                          color: AppColors.inputText,
                          fontWeight: FontWeight.w400,
                          fontSize: 18,),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  height: 56.h,
                  decoration: BoxDecoration(
                    color: selectedIndex == 2 ?const Color(0xFFDFA7A7).withOpacity(0.87) : Colors.transparent,
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        AppText(title: 'Hard - Senior Level',
                          color: AppColors.inputText,
                          fontWeight: FontWeight.w400,
                          fontSize: 18,),
            ...
            selectedJob = value;
              ...
              choiceApplied
                ...
                onTap: selectedJob != null
                    ? () {
                  print('Starting chat for $selectedJob at level $selectedIndex');
                  RouteUtils.push(context, ChatbotItself());
                }
                    : null,
              )
                  : InkWell(
